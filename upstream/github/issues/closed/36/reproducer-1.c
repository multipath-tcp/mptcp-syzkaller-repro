...
void execute_one(void)
{
  ...
  NONFAILING(*(uint16_t*)0x200013c2 = htobe16(0x4e20));
  NONFAILING(*(uint32_t*)0x200013c4 = htobe32(0xe0000002));
  ...
  NONFAILING(memcpy((void*)0x20000080, "\xff", 1));
  NONFAILING(*(uint64_t*)0x20000008 = 0xfffffdef);
  NONFAILING(*(uint64_t*)0x20000298 = 4);
  NONFAILING(*(uint64_t*)0x200002a0 = 0);
  NONFAILING(*(uint64_t*)0x200002a8 = 0);
  NONFAILING(*(uint32_t*)0x200002b0 = 0);
  syscall(__NR_sendmsg, r[0], 0x20000280ul, 0x40ul);
  res = syscall(__NR_accept, r[1], 0ul, 0ul);
  if (res != -1)
    r[2] = res;
  syscall(__NR_recvfrom, r[2], 0x20000140ul, 0xfffffffffffffdd2ul, 0ul, 0ul,
          0ul);
